...
import threading
from person_ai import PersonAI
...
def create_test():
	...
	if request.method == 'POST':
		...
		try:
			...
			print("Exception:", e)
			flash('Invalid Input File Frmat','danger')
...
def test(testid):
	...
	if request.method == 'GET':
		...
		t1 = threading.Thread(target=personai.detection, args=())
		t1.start()
		if personai.continuous_distraction==True or personai.no_person==True:
			print("Distraction:", personai.continuous_distraction)
			print("No Person:", personai.no_person)
			session.permanent = True
...
# update teachers set start='2022-10-27 00:00:00', end='2022-10-27 12:00:00', duration = 43200 WHERE test_id = 'grinning-salamander';
# DELETE from studenttestinfo where  test_id = 'grinning-salamander';
